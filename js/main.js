...
$(document).ready(function () {
    ...
    if (videoElement.data("current-video") !== videourl) {
      videoElement.html(
        '<iframe src="http://www.youtube.com/embed/' +
          videourl +
          '" class="liveVideo" allowfullscreen=""></iframe>'
      );
  ...
  /* -------------- achivement -----------*/
  var heightachivement = $(
    ".achivementwrapper .achievement li .figcontentachv"
  ).innerHeight();
  $(".achivementwrapper .achievement li .fig").css("height", heightachivement);
  $(".achivementwrapper .achievement li .fig").css(
    "line-height",
    heightachivement + "px"
  );
  ...
  function updatetpl(image, name, price, quantity, id, type) {
    ...
    if (type === 1) {
      return (
        ...
        '<select class="form-control" data-id="' +
        id +
        '">' +
        option +
        "</select>" +
...
$(document).ready(function () {
  ...
  $("#tabs-1").show();
  $('.tab[data-tab="tabs-1"]').addClass("active");
  ...
  var targetDate = new Date(2025, 1, 20, 12, 0, 0);
  if (currentDate.getTime() >= targetDate.getTime()) {
    document.getElementById("registrationStatus").innerText =
      "Registeration Closed";
    document.getElementById("registrationStatus").classList.add("disabled");
    document.getElementById("registrationStatus3").classList.add("disabled");
    document.getElementById("registrationStatus2").innerText =
      "Registeration Closed";
    document.getElementById("registrationStatus2").classList.add("disabled");
    document.getElementById("registrationStatus3").classList.add("disabled");
    document.getElementById("registrationStatus4").classList.add("enabled");
  } else {
    document.getElementById("registrationStatus").innerText = "Register";
  }
});
